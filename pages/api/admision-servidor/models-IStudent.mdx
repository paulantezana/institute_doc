...
- **Address(requerido)** Campo para almacenar la direccion de recidencia del alumno
- **BirthDate(requerido)** Campo para almacenar la fecha de nacimiento del alumno
- **BirthPlace(requerido)**  Campo para almacenar el lugar de nacimiento del alumno
- **Country(requerido)**  Campo para almacenar el pais de origen del alumno
- **District(requerido)**  Campo para almacenar el distrito de nacimiento del alumno
- **Province(requerido)**  Campo para almacenar la provincia de nacimiento del alumno
- **Region(requerido)**  Campo para almacenar la región de nacimiento del alumno
- **MarketStall(requerido)** Campo para almacenar en la que trabaja actualmente el alumno en cuestión
- **CivilStatus(requerido)** Campo para almacenar el estado civil del alumno
- **IsWork(requerido)** Campo para almacenar si el alumno trabaja o no
    - `si`
    - `no`